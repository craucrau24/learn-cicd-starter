...
func TestGetApiKey(t *testing.T) {
	...
	}{"missing header": {hname: "Foo", hvalue: "Bar", want: struct {
		value   string
		success bool
	}{value: "", success: false}},
		"wrong header (1field)": {hname: "Authorization", hvalue: "ApiKey", want: struct {
			value   string
			success bool
		}{value: "", success: false}},
		"wrong header (wrong auth type)": {hname: "Authorization", hvalue: "Foo Bar", want: struct {
			value   string
			success bool
		}{value: "", success: false}},
		"correct header": {hname: "Authorization", hvalue: "ApiKey FooBar", want: struct {
			value   string
			success bool
		}{value: "FooBar", success: true}},
	}
